...
str RUNID = "4x4_refract_010"	    // default ID string for output file names
...
// Set to the default 0.010 sec abs_refract
  setfield /library/cell/soma/spike thresh 0  abs_refract 0.010  output_amp 1
end
