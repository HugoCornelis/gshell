...
str RUNID = "4x4_refract_020"	    // default ID string for output file names
...
//  Change to a larger value than the default 0.010 sec abs_refract
  setfield /library/cell/soma/spike thresh 0  abs_refract 0.020  output_amp 1
end
