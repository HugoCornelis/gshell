...
class PlotFrame(wx.Frame):
	...
	proper dimensions, filled with zeroes.
        ...
        self.im = self.axes.imshow(data0, cmap=cm.afmhot, origin='lower')

        # http://matplotlib.sourceforge.net/examples/pylab_examples/show_colormaps.html
        # shows examples to use as a 'cold' to 'hot' mapping of value to color
        # cm.gnuplot and cm.afmhot are good choices, but are unlike G2 'hot'

        self.im.cmap=cm.afmhot
...
class MainApp(wx.App):
    def OnInit(self):
       frame = PlotFrame("G-3 Network View 1.6", (50, 60), (480, 640))
       frame.Show()
